...
export default function Sidebar({ children, setExpanded }) {
  ...
  return (
    <aside className={`fixed top-0 left-0 h-screen bg-white border-r shadow-sm transition-all duration-300 ${expanded ? 'w-64' : 'w-16'}`}>
      <nav className="h-full flex flex-col">
        <div className="p-4 pb-2 flex justify-between items-center">
          {/* <img
            ...
            alt=""
          /> */}
          <p className={`font-semibold text-sm overflow-hidden transition-all ${expanded ? "w-32" : "w-0"}`}>Hotel Extensions</p>
          <button
        ...
        <div className="border-t flex p-3">
          ...
          >
            <div className="leading-4">
              ...
              <span className="text-xs text-gray-600">henriquegaspar14@gmail.com</span>
            </div>
          </div>
        </div>
      </nav>
